    ...
    describe('question group', function() {
      ...
      describe('closing the feedback form', function() {
        ...
        it('closes the feedback form and shows the read-only view', function() {
          ...
          expect(readonlyAnswer(16)).to.equal('Lista, monta valittavissa: A')
          expect(readonlyAnswer(17)).to.equal('Lista, monta valittavissa: B')
          expect(readonlyAnswer(18)).to.equal('Tekstikenttä, yksi vastaus: A')
          expect(readonlyAnswer(19)).to.equal('Tekstikenttä, monta vastausta: A')
          expect(readonlyAnswer(20)).to.equal('Tekstikenttä, monta vastausta: B')
          expect(readonlyAnswer(21)).to.equal('Tekstialue: AAAAA')
